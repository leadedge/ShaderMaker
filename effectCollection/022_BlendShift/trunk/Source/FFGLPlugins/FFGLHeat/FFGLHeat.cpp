...
//   .... <- max length
	"S022",								// Plugin unique ID											
//   ................ <- max length
	"sOm-BlendShift ",					// Plugin name											
...
" vec4 colorTarget=      blend*  texture2D(iChannel1,gl_TexCoord[1].xy);"
" float value=length(colorTarget.xyz)*blend;"
"    vec4 colorSource=  texture2D(iChannel0,gl_TexCoord[1].xy+value );" 
"gl_FragColor=mix(colorSource,colorTarget,blend);" 
"" 
""
"}" 
""
