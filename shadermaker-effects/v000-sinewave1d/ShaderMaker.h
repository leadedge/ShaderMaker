...
protected:	
	...
	float m_UserAmplitude1;

	float m_UserAmplitude2;

	float m_UserAmplitude3;
	...
	float m_UserWavelength1;
	float m_UserWavelength2;
	float m_UserWavelength3;
	...
	GLint m_timesLocation;
	GLint m_frequencyLocation;
	GLint m_wavelengthLocation;
