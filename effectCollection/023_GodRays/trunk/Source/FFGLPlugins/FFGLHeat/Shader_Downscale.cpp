...
void ShaderDownscale::createShaders(FFGLExtensions *e)
{
	...
	m_useAlphaLocation= FindUniform("useAlpha"); 
...
void ShaderDownscale::setLightRadius(float newBias){
	...
	void ShaderDownscale::setUseAlpha(bool newVal){
		m_extensions->glUniform1fARB(m_useAlphaLocation,newVal?1.0:0.0); 
