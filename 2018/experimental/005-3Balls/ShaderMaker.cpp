...
ShaderMaker::ShaderMaker():CFreeFrameGLPlugin()
{
	...
	SetParamInfo(FFPARAM_RED,           "Zoom",           FF_TYPE_STANDARD,1.0f); m_UserRed = 0.1f;
	SetParamInfo(FFPARAM_GREEN,         "Start of Alternation",         FF_TYPE_STANDARD, 0.5f); m_UserGreen = 0.0f;
	SetParamInfo(FFPARAM_BLUE,          "Rotation",          FF_TYPE_STANDARD, 0.0f); m_UserBlue = 0.0f;
 	SetParamInfo(FFPARAM_ALPHA,         "MaxIter",         FF_TYPE_STANDARD, 1.0f); m_UserAlpha = .1f;
