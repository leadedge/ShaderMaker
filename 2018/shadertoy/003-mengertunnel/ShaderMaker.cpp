...
#define FFPARAM_SPEED2       (1111)
#define FFPARAM_SPEED3       (1112)
#define FFPARAM_SPEED4       (1113)

#define FFPARAM_MOUSEX      (1) 
#define FFPARAM_MOUSEY      (2)
#define FFPARAM_MOUSELEFTX  (1116)
#define FFPARAM_MOUSELEFTY  (117)

#define FFPARAM_RED         (210)
#define FFPARAM_GREEN       (1121)
#define FFPARAM_BLUE        (2112)
#define FFPARAM_ALPHA       (213)
...
static CFFGLPluginInfo PluginInfo ( 
	...
	"ST03",								// *** Plugin unique ID (4 chars) - this must be unique for each plugin
	"SoM ST Menger Journey",						// *** Plugin name - make it different for each plugin 
	...
	"sOm Shadertoyg MengerTunnel", // *** Plugin description - you can expand on this
	"https://www.shadertoy.com/view/Mdf3z7"			// *** About - use your own name and details
);
...
const vec3 LightDir= vec3(1.0);
  vec3  LightColor= iParam3.xyz;
const vec3 LightDir2 =vec3(1.0,-1.0,1.0);
vec3 LightColor2= iParam3.xyz;
...
*/	
	SetParamInfo(FFPARAM_PARAM2_X,         "Red 1",         FF_TYPE_RED, 0.5f); m_UserParam2x = 0.0f;
	SetParamInfo(FFPARAM_PARAM2_Y,         "Green 1",         FF_TYPE_GREEN, 0.75f); m_UserParam2y = 0.0f;
	SetParamInfo(FFPARAM_PARAM2_Z,         "Blue 1",         FF_TYPE_BLUE, 0.75f); m_UserParam2z = 0.0f;	
	SetParamInfo(FFPARAM_PARAM2_W,         "Alpha 1",         FF_TYPE_STANDARD, 0.5f); m_UserParam2w = 0.25f;

	SetParamInfo(FFPARAM_PARAM3_X,         "Red 2", FF_TYPE_RED, 0.750f); m_UserParam3x = 0.750f;
	SetParamInfo(FFPARAM_PARAM3_Y,         "Green 2", FF_TYPE_GREEN, 0.750f); m_UserParam3y = 0.750f;
	SetParamInfo(FFPARAM_PARAM3_Z,         "Blue 2", FF_TYPE_BLUE, 0.750f); m_UserParam3z = 0.750f;
	SetParamInfo(FFPARAM_PARAM3_W,         "Alpha 2",         FF_TYPE_STANDARD, 0.70f); m_UserParam3w = 0.75f;
