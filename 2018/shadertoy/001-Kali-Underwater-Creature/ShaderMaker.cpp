...
#define FFPARAM_VECTOR3_X       (1)
#define FFPARAM_VECTOR3_Y       (2)
#define FFPARAM_VECTOR3_Z       (3)
#define FFPARAM_VECTOR3_W       (100011)

#define FFPARAM_VECTOR4_X       (4)
#define FFPARAM_VECTOR4_Y       (5)
#define FFPARAM_VECTOR4_Z       (6)
#define FFPARAM_VECTOR4_W       (10000015)
#define FFPARAM_VECTOR1_X       (7)
#define FFPARAM_VECTOR1_Y       (100010)
...
#define FFPARAM_VECTOR5_X       (14)
#define FFPARAM_VECTOR5_Y       (15)
#define FFPARAM_VECTOR5_Z       (16)
...
mat3 rots[3] = mat3[3](
	rotationMatrix3(normalize(RotVector + aniXXX), RotAngles[0] + sin(time)*10.),
	rotationMatrix3(normalize(RotVector + aniXXX), RotAngles[1] + sin(time)*10.),
...
ShaderMaker::ShaderMaker() :CFreeFrameGLPlugin()
{
	...
	SetParamInfo(FFPARAM_VECTOR5_X, "Inclination", FF_TYPE_STANDARD, 0.75f);
	SetParamInfo(FFPARAM_VECTOR5_Y, "Elevation", FF_TYPE_STANDARD, 0.2f);
