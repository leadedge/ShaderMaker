...
#define FFPARAM_SINYSPEED1	  (3)
#define FFPARAM_SINYSPEED2	  (4)
#define FFPARAM_SINYVARIANCE1  (5) 
#define FFPARAM_NUMDOTS  (6)
#define FFPARAM_DOTSIZE  (7)
#define FFPARAM_BEATDOTSIZE  (8)
#define FFPARAM_BEATDOTRANGE  (9)
#define FFPARAM_RESYNC  (10)
...
static CFFGLPluginInfo PluginInfo ( 
	...
	"GLBEATV1",								// Plugin unique ID											
	"sOm-StroboSine",					// Plugin name											
	1,						   			// API major version number 													
	000,								  // API minor version number	
	1,										// Plugin major version number
	000,									// Plugin minor version number
	FF_SOURCE,						// Plugin type
	"sOm-StroboSine",	// Plugin description
	"(c) by VJSpack-O-Mat aka Christian Kleinhuis aug2014 - Sine dots with scalable middle point. " // About
);
...
"   col_out= circleBeatLine(texCoord, calctime,1);"    
 ...
 m_maxCoordsLocation(-1)
{
	...
	SetParamInfo(FFPARAM_SINXSPEED1, "XSpeed1", FF_TYPE_STANDARD, 0.5f);
	SetParamInfo(FFPARAM_SINXSPEED2, "XSpeed2", FF_TYPE_STANDARD, 0.250f);
	SetParamInfo(FFPARAM_SINXVARIANCE1, "XVariance1", FF_TYPE_STANDARD, 0.03f); 
	SetParamInfo(FFPARAM_SINYSPEED1, "YSpeed1", FF_TYPE_STANDARD, 0.2f);
	SetParamInfo(FFPARAM_SINYSPEED2, "YSpeed2", FF_TYPE_STANDARD, 0.1f);
	SetParamInfo(FFPARAM_SINYVARIANCE1, "YVariance", FF_TYPE_STANDARD, 0.05f); 
	SetParamInfo(FFPARAM_NUMDOTS, "DotCount(*100)", FF_TYPE_STANDARD, 0.05f);
