...
static CFFGLPluginInfo PluginInfo ( 
	...
	"S067",								// *** Plugin unique ID (4 chars) - this must be unique for each plugin
	"sOm-Rose",						// *** Plugin name - make it different for each plugin 
	...
	"sOm-Rose", // *** Plugin description - you can expand on this
...
{
	float gTime = -iGlobalTime*10-2.3;
