...
public:
	...
	void getEulerMatrix(float matrix[],float x,float y,float z);

	void getRotMatrix(float matrix[],float angle,float x,float y,float z);

	void getRotMatrixFromSpherical(float matrix[],float angle,float phi,float theta);
...
protected:	
	...
	GLint m_rotationMatrixLocation;
	GLint m_rotationMatrixLocation2;
	GLint m_rotationMatrixLocation3;
