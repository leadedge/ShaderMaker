...
static CFFGLPluginInfo PluginInfo ( 
	...
	"S071",								// Plugin unique ID											
	"sOm-SineLines",					// Plugin name											
	1,						   			// API major version number 													
	000,								  // API minor version number	
	1,										// Plugin major version number
	000,									// Plugin minor version number
	FF_SOURCE,						// Plugin type
	"sOm-SineLines",	// Plugin description
...
"             vec4("
"					sin(sineFactors.x+(sineFactors.y*50)*gl_Vertex.x/1000.0)*amplitudes.x"
","
"					cos(sineFactors.z+(sineFactors.w*50)*gl_Vertex.x/1000.0)*amplitudes.z,"
" gl_Vertex.z,gl_Vertex.w) ;"
"}else{"
"  gl_Position =gl_ModelViewProjectionMatrix*  "
"             vec4("
"					sin(sineFactors2.x+(sineFactors2.y*50)*gl_Vertex.x/1000.0)*amplitudes.y"
","
"					cos(sineFactors2.z+(sineFactors2.w*50)*gl_Vertex.x/1000.0)*amplitudes.w,"
" gl_Vertex.z,gl_Vertex.w) ;"
"}"
...
double FFGLHeat::GetTimeInSecondsSinceStart(){
   ...
   m_sinXVarianceCurrent=m_sinXVariance;
   m_sinXVariance2Current=m_sinXVariance2;

   m_sinYVarianceCurrent=m_sinYVariance;
   m_sinYVariance2Current=m_sinYVariance2;
